...
The logical components in Figure~\ref{fig:logical-architecture} will be implemented with a modular Python backend and a TypeScript web frontend. One deployable application with a background worker will keep the four-person project manageable while separating collection, modelling, risk calculation and AI explanation.
