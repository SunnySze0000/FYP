...
Next.js and React will provide interactive views; FastAPI and Pydantic will validate requests and share calculation services with the assistant \cite{nextjs,fastapi}. Polars/Pandas, NumPy and scikit-learn will support research. PostgreSQL will hold linked records and run metadata, while Parquet preserves raw evidence and research datasets. A Python worker and Docker Compose will support one manageable deployment.
