...
Application & FastAPI, Pydantic, Next.js/React, TypeScript and TanStack Query & Validated backend APIs and interactive interface. \\
Data and modelling & PostgreSQL/pgvector, SQLAlchemy, Parquet, Polars, NumPy and scikit-learn & Storage, processing and initial statistical models. \\
Assistant candidates & CrewAI, Sentence Transformers and optional MCP adapter & Agent workflow, evidence retrieval and typed tool access. \\
...
External costs may include adjusted equity histories, indexed blockchain access, archival RPC, a hosted language model and server hosting. Subject to final confirmation of the currency and available funding, the project will plan for an indicative external-service budget of 1,000--2,000. Spending will prioritise historical market data, indexed blockchain access and hosted-model usage. Costs will be reviewed during the feasibility stage, with free-tier or locally hosted alternatives used where practical. A paid historical options dataset is not required for the core project. Software dependencies, model versions and configuration will be recorded to support reproducibility.
