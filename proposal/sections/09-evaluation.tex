...
\begin{table}[H]
\smalltable
\caption{How each objective will be evaluated (indicative; refined after the feasibility audit).}
\begin{tabularx}{\linewidth}{@{}L{20mm} L{42mm} Y@{}}
\toprule\tablehead
\textbf{Objective} & \textbf{Question} & \textbf{Indicative metric} \\
\midrule
Wallet identification & Does the smart-wallet score capture information beyond chance? & Backtested accuracy/Brier score vs.\ a label-shuffled baseline; sensitivity to the eligibility threshold \\
...
Volatility forecasting & Does the augmented model beat a conventional baseline? & Variance error and QLIKE vs.\ historical/EWMA volatility; VaR exceedance rate \\
