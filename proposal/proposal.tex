...
\usepackage{setspace,titlesec,fancyhdr,tikz,tocloft,pgfplots}
...
\input{sections/04-design-overview}
\input{sections/05-data-design}
\input{sections/06-analytics}
\input{sections/07-delivery}
\input{sections/08-architecture}
\input{sections/09-evaluation}
\input{sections/10-delivery}
\input{sections/11-resources}
\pagechapter{References}
\input{references}
\input{sections/12-meeting-minutes}
\end{document}
